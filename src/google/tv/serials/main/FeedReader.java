...
import java.util.*;
 ...
 public class FeedReader{	 
				...
				for (Iterator iterator = feed.getEntries().iterator(); iterator.hasNext();) {	
					...
					//System.out.println(count+"--"+titleList);
					 ...
					 if(channel.equals("chithi") || channel.equals("vikatan") 
						     ...
						     || channel.equals("vijaytv") || channel.equals("lankasri")|| channel.equals("tamilhindu")
						     
						     || channel.equals("sonysouth")|| channel.equals("thinkmusic")|| channel.equals("studiogreen")
						     || channel.equals("lyca")|| channel.equals("wunderbarstudios")){
					 ...
					 if(channel.equalsIgnoreCase("thiru") || channel.equalsIgnoreCase("vision") || channel.equalsIgnoreCase("cinetimes")
						...
						if(channel.equalsIgnoreCase("thanti") || channel.equalsIgnoreCase("PTM") || channel.equalsIgnoreCase("nakkheeranwebtv")){
							channel="news";
								...
								|| channel.equalsIgnoreCase("galattavideos") || channel.equalsIgnoreCase("IGtamil")){
							channel="cinema news";
						}
						
						if(channel.equalsIgnoreCase("sonysouth") || channel.equalsIgnoreCase("thinkmusic") || channel.equalsIgnoreCase("studiogreen")
								|| channel.equalsIgnoreCase("lyca") || channel.equalsIgnoreCase("wunderbarstudios")){
							channel="trailer";
						}
						//if(lang.equalsIgnoreCase("tamil")){

							
						serialTitle= serialTitle.replaceAll("[^\\x00-\\x7F]", "");
						boolean flagOTP=DatabaseManager.postlookup(serialTitle,"onlinetamilportal");
							if(!flagOTP)
								//Wpost.main(serialTitle, thumbImg+"0.jpg\"/>"+"<BR><BR><BR>"+serialContent,channel,channel+","+serialTitle+","+serialDate,"onlinetamilportal");
								Wpost.main("",channel,serialTitle, thumbImg+"0.jpg\"/>"+"<BR><BR><BR><BR><BR><h3>Click on the below link to view the Video</h3><BR><BR>"+refinedContent,channel,channel+","+serialTitle+","+serialDate,"onlinetamilportal","");
							
						//}
						/*if(lang.equalsIgnoreCase("Kannada")){
							boolean flagOKP=DatabaseManager.postlookup(serialTitle,"onlinetamilportal");
							if(!flagOKP)
								Wpost.main("",channel,serialTitle, thumbImg+"0.jpg\"/>"+"<BR><BR><h3>Click on the below link to view the Video</h3><BR><BR>"+refinedContent,channel,channel+","+serialTitle+","+serialDate,"onlinekanadaportal","");
						}else if(lang.equalsIgnoreCase("telugu")){
							boolean flagOTEP=DatabaseManager.postlookup(serialTitle,"onlinetamilportal");
							if(!flagOTEP)
								Wpost.main("",channel,serialTitle, thumbImg+"0.jpg\"/>"+"<BR><BR><h3>Click on the below link to view the Video</h3><BR><BR>"+refinedContent,channel,channel+","+serialTitle+","+serialDate,"onlineteluguportal","");
						}else if(lang.equalsIgnoreCase("hindi")){
							boolean flagOHP=DatabaseManager.postlookup(serialTitle,"onlinetamilportal");
							if(!flagOHP)
								Wpost.main("",channel,serialTitle, thumbImg+"0.jpg\"/>"+"<BR><BR><h3>Click on the below link to view the Video</h3><BR><BR>"+refinedContent,channel,channel+","+serialTitle+","+serialDate,"onlinehindiportal","");
						}*/
	 ...
	 * public static void main(String args[]) throws SQLException{	
		...
		//serialNameList.add("vikatan");
		//serialNameList.add("radan");
		//serialNameList.add("suntv");
		//serialNameList.add("set");
		serialNameList.add("colors");
		serialNameList.add("gemini");
		serialNameList.add("surya");
		//serialNameList.add("thiru");
		serialNameList.add("thanti");
		//serialNameList.add("karai");
		//serialNameList.add("rajtv");
		//serialNameList.add("vision");
		//serialNameList.add("cinetimes");
		//serialNameList.add("homemovie");
		//serialNameList.add("polimer");
		//serialNameList.add("setindiatamil");
		serialNameList.add("vendar");
		serialNameList.add("puthuyugam");
		//serialNameList.add("vasanth");
		serialNameList.add("captain");
		//serialNameList.add("jaya");
		serialNameList.add("kalaignar");
		serialNameList.add("etvtelugu");
		//serialNameList.add("maatv");
		//serialNameList.add("maamusic");
		serialNameList.add("teluguserials");
		serialNameList.add("udayatv");
		serialNameList.add("etvkannada");
		serialNameList.add("etvmarathi");
		serialNameList.add("etvbangla");
		serialNameList.add("etvgujarati");
		//serialNameList.add("sarthaktv");
		serialNameList.add("etvodia");
		serialNameList.add("PTM");
		
		//serialNameList.add("behindwoodstv");
		//serialNameList.add("IGtamil");
		//serialNameList.add("IGtelugu");
		
		//serialNameList.add("igbollywood");
		//serialNameList.add("igmalayalam");
		//serialNameList.add("igkannada");
		//serialNameList.add("cinemavikatan");
		serialNameList.add("nakkheeranwebtv");
		
		serialNameList.add("galattavideos");
		serialNameList.add("GalattaHindi");
		serialNameList.add("GalattaMalayalam");
		serialNameList.add("GalattaKannada");
		serialNameList.add("apoorva");
		serialNameList.add("SANMEDIATV");
		serialNameList.add("abinaya");
...
public static void main(String args[]) throws SQLException{	
		...
		System.out.println("START of Youtube");
		List<String> serialNameList=new ArrayList<String>();
		//Connection conn=DatabaseManager.getConnection("onlinetamilportal");
		serialNameList.clear();
		...
		serialNameList.add("sonysouth");
		serialNameList.add("thinkmusic");
		serialNameList.add("studiogreen");
		serialNameList.add("lyca");
		serialNameList.add("wunderbarstudios");*/
		...
		System.out.println("END of Youtube : "+new Date());
